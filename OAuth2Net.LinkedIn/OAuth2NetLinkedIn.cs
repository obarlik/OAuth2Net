...
{
    public class OAuth2LinkedInApi : OAuth2.Api.OAuth2Api
    {        
        ...
        public OAuth2LinkedInApi(
            string client_id,
            string client_secret,
            string redirect_uri,
            Action<OAuth2LinkedInApi> success,
            Action<OAuth2LinkedInApi> failure,
            ...
            : base( 
                ...
                success_api => 
                {
                    var linkedInApi = success_api as OAuth2LinkedInApi;
                ...
                failure_api => failure((OAuth2LinkedInApi)failure_api))
        {
